...
Plugin URI: http://iconosquare.com
...
Version: 1.0.5
Author: Iconosquare
Author URI: http://iconosquare.com
Author Email: help@iconosquare.com
...
class StatigramWidget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::__construct(
            'statigram-id',
            __('Iconosquare Widget', 'statigram-locale'),
            array(
        ...
        add_shortcode('iconosquare_widget', array(new StatigramWidgetDb(), 'renderIframe'));
    }
